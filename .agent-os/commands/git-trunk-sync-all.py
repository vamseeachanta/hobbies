...
if "sync-all" in "git-trunk-sync-all":
    new_args.extend(["sync", "--all"])
elif "sync" in "git-trunk-sync-all":
    new_args.append("sync")
elif "trunk-flow" in "git-trunk-sync-all":
    new_args.append("trunk")
elif "trunk-status" in "git-trunk-sync-all":
    new_args.append("status")
elif "commit" in "git-trunk-sync-all":
