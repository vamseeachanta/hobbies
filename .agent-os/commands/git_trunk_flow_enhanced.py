...
if "sync-all" in "git_trunk_flow_enhanced":
    new_args.extend(["sync", "--all"])
elif "sync" in "git_trunk_flow_enhanced":
    new_args.append("sync")
elif "trunk-flow" in "git_trunk_flow_enhanced":
    new_args.append("trunk")
elif "trunk-status" in "git_trunk_flow_enhanced":
    new_args.append("status")
elif "commit" in "git_trunk_flow_enhanced":
